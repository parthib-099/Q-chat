    ...
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3
       mx-4 border-b border-stone-500'>
        ...
        <img onClick={() => setSelectedUser} src={assets.arrow_icon} alt=""
           ...
           ${msg.senderId !='680f50e4f10f3cd28382ecf9' && 'flex-row-reverse'}`}>
            {msg.image ?(
              ...
              <p className={`p-2 max-w-[200px] md:text-sm font-light 
                rounded-light mb-8 break-all bg-violet-500/30 text-white
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          <input type="text" placeholder="send amessage" className='flex-1 text-sm p-3 border-none rounded-lg
