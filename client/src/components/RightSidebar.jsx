...
const RightSidebar = ({selectedUser}) => {
  return selectedUser &&(
    <div className={`bg-[#8185B2]/10 text-white w-full
     relative overflow-y-scroll ${selectedUser ?"max-md:hidden":""}`}>

      <div className='pt-16 flex flex-col items-center
       gap-2 text-xs font-light mx-auto'>
        <img src={selectedUser?.profilePic || assets.avatar_icon}
       alt="" className='w-20 aspect-[1/1] rounded-full' />
       <h1 className='px-10 test-xl font-medium
        mx-auto fles-items-center gap-2'>
       ...
       <div className='px-5 text-xs'>
        ...
        <div className='mt-2 max-h-[200px]
         overflow-y-scroll grid grid-cols-2 gap-4 opacity-80'>
